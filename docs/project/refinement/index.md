...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR053](rs008-v0319-recursive-journey-parity/cr053-port-conservative-transactional-journey-removal.md) | RS008 | Port conservative transactional journey removal | in_progress | @alissonvale | `mirror-ts-core` |
