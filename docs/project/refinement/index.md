...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR050](rs008-v0319-recursive-journey-parity/cr050-reconcile-moving-target-and-parent-authority.md) | RS008 | Reconcile moving-target policy and parent authority | in_progress | @alissonvale | `mirror-ts-core` |
