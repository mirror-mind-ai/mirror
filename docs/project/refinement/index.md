...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR052](rs008-v0319-recursive-journey-parity/cr052-port-parent-movement-and-cycle-semantics.md) | RS008 | Port parent movement and cycle semantics | captured | — | — |
