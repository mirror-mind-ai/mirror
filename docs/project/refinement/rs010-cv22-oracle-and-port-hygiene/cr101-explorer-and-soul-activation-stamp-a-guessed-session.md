...
- `explore load` (`ts/src/frontDoor/exploreRoute.ts`, `runLoad`) resolves the
  ...
  ([CR100](cr100-the-session-resolver-guesses-from-a-table-of-three-row-kinds.md)).
...
[CR008's plan](../rs001-ariad-runtime-trust/cr008-bind-lifecycle-commands-to-active-journey.md) as that
plan's excluded write-side twin.

Filed under RS001 as CR008's twin, then moved to RS010 on 2026-09-25 by the
Navigator's decision. Explorer and Soul are not Ariad, and this sits beside
CR100, whose resolver it uses.
