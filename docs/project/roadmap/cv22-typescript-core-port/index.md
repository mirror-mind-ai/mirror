...
**Status:** 🟢 Active — restarted 2026-09-02 after pause-window reconciliation; **DS8 live-provider cutover done 2026-09-13 (5/5)**; DS7 command burn-down at 12/15, next US8 (Builder/Ariad tree). No Delivery Story creates a release boundary — CV22 [releases once, when the migration is complete](../../decisions.md#cv22-releases-once-when-the-migration-is-complete)
