...
| `conversation-logger session-start (full)\|session-maintenance` | DS7.US10 | group 2 of the close tail; awaits the DS8.US2 group 2 flip. `switch\|session-end-pi\|session-end` went live 2026-09-11 — see below |
...
**Twelve leaves** (sixteen at the start of DS8; `memories --search` left on
2026-09-11 with US1, and the close tail's group 1 — `switch`,
`session-end-pi`, `session-end` — on 2026-09-11 with US2). What remains here
is group 2 of the close tail plus the ten low-traffic leaves DS8.US3 owns.
