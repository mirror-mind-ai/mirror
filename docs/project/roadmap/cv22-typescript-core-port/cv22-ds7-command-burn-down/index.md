...
**Status:** 🟢 In Progress — US1–US4 and TS2 are done (**5/11**); US5–US9 and TS1 remain. TS2 removed US4's whole-command extension fallback through TS-owned `mirror-context-v1`; its finite Python compatibility host has mandatory deletion ownership in DS10.
**Type:** Delivery Story
