...
| CV22.DS7.US7 | Explorer Mode | User Story | `explore` exploratory-story surfaces answered by TS, with projection refresh delegated to Python behind a named DS10-owned seam (med risk) | 🔵 In progress — plateau 1 of 6 done (surfaces ported, graded, nothing routed) |
