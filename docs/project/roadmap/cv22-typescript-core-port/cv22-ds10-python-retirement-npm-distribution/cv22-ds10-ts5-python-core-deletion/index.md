...
4. ~~**The panel's handoff review**~~ — **held 2026-09-25**
   ...
   (`inherited.md`).
5. ~~**Debt Review**~~ — **recorded 2026-09-25** ([review.md](review.md)), decision
   `defer` for what stays carried, each item with a durable home. One item was
   paid instead: **CR084**, whose revisit trigger fired on TS5's own CI, where
   `migrateOnOpenConcurrency` failed on both attempts for `9a3bf1ef`. The
