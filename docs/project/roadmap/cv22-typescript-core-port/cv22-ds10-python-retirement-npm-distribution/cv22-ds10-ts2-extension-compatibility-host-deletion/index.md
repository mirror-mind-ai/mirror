...
I want to Extension compatibility-host deletion,
So that the expected technical outcome is available.

## Outcome

Navigator can validate Extension compatibility-host deletion as an observable behavior.

## Acceptance Behavior

```text
Given the system is ready for Extension compatibility-host deletion
...
- Extension compatibility-host deletion
