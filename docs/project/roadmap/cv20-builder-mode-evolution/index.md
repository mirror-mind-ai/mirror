...
| [CV20.DS4](cv20-ds4-story-lifecycle-runtime/index.md) | Story Lifecycle Runtime | Builder can execute the Pull, Prepare, Plan, Implement, Validation, Review, Coherence, and Done lifecycle with deterministic checkpoint gates | 🟢 Active |
