...
| [CV20.DS2](cv20-ds2-ariad-adoption/index.md) | Ariad Adoption | A journey can be configured to use Ariad, with documentation inventory, template generation, method config, and initial runtime sync | 🟢 Active |
