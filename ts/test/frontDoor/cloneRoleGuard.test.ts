...
function stageTree(root: string, tree: CloneRoleCase["tree"]): void {
  ...
  if (tree.pyproject !== null) writeFileSync(join(root, "pyproject.toml"), tree.pyproject, "utf8");
  else if (tree.src_memory) writeFileSync(join(root, "pyproject.toml"), MIRROR_PYPROJECT, "utf8");
