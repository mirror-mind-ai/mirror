...
INSERT INTO "tasks" ("id", "travessia", "title", "status", "due_date", "stage", "context", "source", "created_at", "updated_at", "completed_at", "metadata") VALUES ('task-legacy-1', 'genesis-project', 'Legacy task', 'todo', NULL, NULL, NULL, 'manual', '2025-01-10T09:20:00Z', '2025-01-10T09:20:00Z', NULL, NULL);
