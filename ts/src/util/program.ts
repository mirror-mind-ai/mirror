...
// program instead, in both its bare and its `uv`-wrapped form, and that program
// no longer exists. Every one of them reads this constant now, so when US3
// names the `bin`, this is the one place that changes.
